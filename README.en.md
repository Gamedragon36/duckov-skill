...
| Item | Detail |
|---|---|
| Skills | **24** (Physical 7 · Combat 6 · Practical 11) |
...
| UI | **F6** opens the skill window (drag the title bar to move), **F7** switches category · each skill shows **XP (current/needed)** and its **per-level value** |
